...
4. Разница меж результатами ping по адресу и по имени - 
ping по 4 8.8.8.8 проверяет базовую связанность
а ping по имени ya.ru сначала делает днс запрос к указанным именам из конфига resolv для преобразования имени в ip 
